...
// const message = `Your message here...`;
  const message = `HBD to My Special One ✨💌🌼

Today is all about you —
the warmth in your smile, the softness in your heart,
and the way your presence lights up my world.

May this year hug you with happiness,
bless you with memories that stay in your heart forever,
and bring every dream you whisper at night to life.
You’re my miracle-and I’ll be here, loving you and supporting you always.

Thank you for being you —
for standing by me ❤️
for supporting me 🤗
for listening to me, even in silence 🫶
for understanding me when words weren’t enough 🥺
for giving me a place in your life, and in your heart.🫂🫀

I’m grateful for you — today, tomorrow, always.
You’re not just special, you’re everything.

Once again, wishing the love of my life
a very Happy Birthday 🎉✨

Click the button below to see what I've done for you.
 `;
        ...
        >
          ...
          {!curtainsOpened && (
            <div ref={curtainHintRef} className="curtain-hint">
               {window.innerWidth <= 768 ? "Tap" : "Click"} to Open 💌🗝️
            </div>
          )}
        </div>
