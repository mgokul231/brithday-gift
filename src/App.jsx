    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Kishuu</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Kishuu</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>You have some msg from your loosu 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">Loving You Always — Kishuu ♡....</h2>
